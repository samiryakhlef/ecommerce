 ...
 */
final class Version20220325173327 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE firstname firstname VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE lastname lastname VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE address address VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE zipcode zipcode VARCHAR(255) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE city city VARCHAR(250) NOT NULL COLLATE `utf8mb4_0900_ai_ci`, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
